...
$(document).ready(function(){
  ...
  {
    var image = document.getElementById("valentin");
      // Cette fonction est appelée lorsque l'image a été chargée
    ctx.drawImage(image,x*cw, y*cw, cw, cw); // this fait référence à l'objet courant (=image)
  ...
  {
    var image = document.getElementById("cafetiere");
      // Cette fonction est appelée lorsque l'image a été chargée
    ctx.drawImage(image,x*cw, y*cw, cw, cw); // this fait référence à l'objet courant (=image)
  }
